...
```bash
# 调用示例
python $HOME/.agents/plugins/ai-founder-influence-os/skills/content-runtime/scripts/content_runtime.py   --project ~/ai-content-system read --step visual --latest
